...
# defining a font
smallfont = pygame.font.SysFont('BLOCKS GAME', 35)
...
# game title
colox = smallfont.render('blocks game', True, (c3, c2, c1)) 
...
def game_over():
    ...
    while True:
        ...
        smallfont = pygame.font.SysFont('BLOCKS GAME', 60)
        smallfont1 = pygame.font.SysFont('BLOCKS GAME', 25)
...
def intro(
    ...
    while intro:
        ...
        pygame.draw.rect(screen, (c2, colox_c1, colox_c2), [width - 40,
                         0, 40, height])
        smallfont = pygame.font.SysFont('BLOCKS GAME', 35)
        sig = smallfont.render('Biancaa', True, green)
        text = smallfont.render('Start', True, white)
        text1 = smallfont.render('Options', True, white)
        exit1 = smallfont.render('Exit', True, white)
